...
const ListModulBelajar = () => {
  ...
  const filteredModuls = modulList.filter(modul =>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className={`text-3xl font-bold ${isDark ? 'text-white' : 'text-gray-800'}`}>
                    <span style={{ color: currentColor }}>Modul Belajar</span> Green Science
                  </h1>
                    ...
                    <div className="relative h-48 overflow-hidden">
                      {modul.image ? (
                        ...
                        >
                          <FaBook 
                            className="text-6xl"
                            style={{ color: getColorWithOpacity(currentColor, 0.3) }}
                          />
                        </div>
                      )}
                      ...
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-2">
                          <div 
                            ...
                            style={{ backgroundColor: getColorWithOpacity(currentColor, 0.1) }}
                          >
                            <FaFileAlt style={{ color: currentColor }} className="text-xs" />
                          </div>
                        ...
                        <div className="flex items-center gap-1">
                          <FaSeedling style={{ color: currentColor }} className="text-xs" />
                          <span className={`text-xs ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
                            Eco Learning
                          </span>
                        </div>
...
<div className="flex items-center gap-2">
  <motion.button
    whileHover={{ scale: 1.05 }}
    whileTap={{ scale: 0.95 }}
    onClick={() => navigate(`/modul-belajar/detail/${modul.id}`)}
    className={`${
  ...
  {user?.role !== 'siswa' && (
    <>
      <motion.button
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
        onClick={() => navigate(`/modul-belajar/edit/${modul.id}`)}
        className="p-2 rounded-lg text-white transition-all duration-300 hover:shadow-lg"
        style={{ backgroundColor: getColorWithOpacity(currentColor, 0.8) }}
      >
            ...
            >
              ...
              <div className="p-6">
                <p className={`mb-4 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Apakah Anda yakin ingin menghapus modul "{selectedModul?.judul}"? 
