...
const EditSubModulBelajar = () => {
  ...
  const getSubModulById = async () => {
    try {
      ...
      const subModulData = response.data;
      setSubJudul(subModulData.subJudul);
      setSubDeskripsi(subModulData.subDeskripsi);
      setUrlYoutube(subModulData.urlYoutube);
      setModulId(subModulData.modulId);
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                >
                  Edit <span style={{ color: currentColor }}>Sub Modul</span>{" "}
                  Belajar
                </h1>
              ...
              <div className="p-8">
                ...
                <form onSubmit={updateSubModul} className="space-y-8">
                  ...
                  >
                    ...
                    >
                      Berikan judul yang spesifik dan mudah dipahami untuk sub
                      modul
                    </p>
                  </div>
                  ...
                  >
                    ...
                    >
                      Tambahkan link video YouTube untuk memperkaya materi
                      pembelajaran
                    </p>
                  </div>
                  ...
                  >
                    ...
                    >
                      ⚠️ Gambar cover wajib diupload untuk sub modul. 💡 Tips: Klik "Ganti" untuk upload gambar baru, "Hapus" untuk menghapus gambar, atau "Batalkan Penghapusan" untuk mempertahankan gambar yang ada.
                    </p>
                  </div>
                ...
                <div className="p-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      >
                        {modulInfo.deskripsi
                          ? modulInfo.deskripsi.length > 100
                            ? `${modulInfo.deskripsi.substring(0, 100)}...`
                            : modulInfo.deskripsi
                          : "Tidak ada deskripsi"}
                      </p>
                    </div>
              ...
              <div className="p-4">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    >
                      {subDeskripsi
                        ? subDeskripsi.length > 100
                          ? `${subDeskripsi.substring(0, 100)}...`
                          : subDeskripsi
                        : "Belum diisi"}
                    </p>
                  </div>
                  ...
                  {subJudul && subDeskripsi && (imagePreview && !removeImage) && (
                    <div className="pt-2">
                      <p
                        className={`text-xs ${
                          isDark ? "text-gray-400" : "text-gray-500"
                  ...
                  {(!subJudul || !subDeskripsi || removeImage || (!imagePreview && !image)) && (
                    <div className="pt-2">
                      <p
                        className={`text-xs ${
                          isDark ? "text-gray-400" : "text-gray-500"
                      ...
                      <span
                        className="px-3 py-1 rounded-full text-xs font-medium text-white bg-red-500"
                      >
                        ❌ Belum lengkap
                      </span>
                    </div>
              ...
              <div className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    >
                      Panduan mengedit sub modul berkualitas:
                    </p>
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        >
                          Link YouTube tetap opsional untuk edit
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        <FaRecycle
